...
<div id='main'>
    ...
    <input type="nom" placeholder="Nom" name="nom" value={$smarty.session.user.nom}><br /> // On utilise le nom qui est dans la variable session
    <span>{$messages['nom']|escape|default:""}</span><br />

    <label><b>Email</b></label><br />
    <input type="email" placeholder="email" name="email" value={$info['email']}><br />  // On utilise la variable utlise dans le GET profil
